...
const App = () => {
    ...
    const apiKeyProvided = API_KEY && API_KEY.length > 5;
        ...
        <div className="min-h-screen bg-gray-900 text-gray-200 p-4 sm:p-8 font-sans">
            ...
            {!apiKeyProvided && (
                <div className="bg-red-600/20 border-l-4 border-red-500 text-red-100 p-4 mb-6 rounded-lg max-w-6xl mx-auto" role="alert">
                    ...
                    <p>The **API Key is missing**. Please paste your valid Google AI key into the `const API_KEY = ""...` line in the `App.jsx` file to enable image generation.</p>
                </div>
            )}
